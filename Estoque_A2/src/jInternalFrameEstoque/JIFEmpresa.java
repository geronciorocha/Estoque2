...
public class JIFEmpresa extends javax.swing.JInternalFrame {
    ...
    private List<GupoProduto> gupoProdutoList = new ArrayList<>();
    
    public JIFEmpresa() {
        try {
            EMPRESA = new Controller().ControllerFind(Empresa.class, 1);
            tipoPagamentoList = (List<TipoPagamento>) new Controller().ControllerFindAll(TipoPagamento.class);
            gupoProdutoList = (List<GupoProduto>) new Controller().ControllerFindAll(GupoProduto.class);
            initComponents();
            ...
            jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
                ...
                public void valueChanged(ListSelectionEvent e) {
                    ...
                    if (selected != -1) {
                        try {
                            buscaBanco(EMPRESA.getTipoPagamentoList().get(selected).getCodigoBanco().getCodigoBanco());
                        } catch (Exception ex) {
            ...
            for (int i = 0; i < EMPRESA.getTipoPagamentoList().size(); i++) {
                modelTableFormaPagamento.setNumRows(jTable1.getRowCount() + 1);
                jTable1.setModel(modelTableFormaPagamento);
                jTable1.setValueAt(EMPRESA.getTipoPagamentoList().get(i).getDescricaoTipoPagamento(), jTable1.getRowCount() - 1, 0);
            }
            ...
            for (int i = 0; i < EMPRESA.getTipoPagamentoAvistaList().size(); i++) {
                ...
                jTable5.setModel(modelTableFormaPagamentoAvista);
                try {
                    jTable5.setValueAt(EMPRESA.getTipoPagamentoAvistaList().get(i).getDescricaoTipoPagamento(), jTable5.getRowCount() - 1, 0);
            ...
            for (int i = 0; i < EMPRESA.getTipoPagamentoPromissoriaList().size(); i++) {
                ...
                jTable4.setValueAt(EMPRESA.getTipoPagamentoPromissoriaList().get(i).getTipoPagamento().getDescricaoTipoPagamento(), jTable4.getRowCount() - 1, 0);
            }
    ...
    public void situacaoTributaria() {
    ...
    public void setValueEmpresa() {
        ...
        try {
            jTextField13.setText(String.valueOf(EMPRESA.getTelefone()));
        } catch (Exception e) {
        }
        try {
        ...
        try {
            if (EMPRESA.getConfiguracao().getCalcComissao() == 0) {
                jCheckBox20.setSelected(true);
                    ...
                    } else switch (EMPRESA.getConfiguracao().getTipoComissao()) {
                    case 1:
    ...
    public void homologacaoProducao() {
            ...
            pardigital = 
                EMPRESA.getPardigitalList().get(0).getEmpresa().getTpEmissao()!=1 
                    ? EMPRESA.getPardigitalList().get(1) : EMPRESA.getPardigitalList().get(0);
    ...
    public void consulta(int codigo) {
        try {
            ...
            CidadeCodigo codcidade = new Controller().ControllerFind(CidadeCodigo.class, filtro);
            if(codcidade!=null){
    ...
    public void buscaBanco(Integer codigo) {
        try {
            HashMap filtro = new HashMap();
            filtro.put("codigoBanco", codigo);
            ContaBancaria contaBancaria = new Controller().ControllerFind(ContaBancaria.class, filtro);
    ...
    private void jCheckBox13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox13ActionPerformed
        ...
        if (jCheckBox13.isSelected()) {
            ...
            jTable4.setEnabled(false);
            jButton4.setEnabled(false);
            EMPRESA.setEmissaoPromissoria(0);
        }
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        try {
            ...
            if (ob != null) {
                ...
                new Controller().ControllerRemove(ob);
    ...
    private void Remov1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Remov1ActionPerformed
        try {
            new Controller().ControllerRemove(EMPRESA.getTipoPagamentoAvistaList().get(jTable5.getSelectedRow()));
    ...
    private void Remov2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Remov2ActionPerformed
        try {
            new Controller().ControllerRemove(EMPRESA.getTipoPagamentoList().get(jTable1.getSelectedRow()));
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        try{
        alq = (AliquotaSimplesNacional) jTable6.getValueAt(jTable6.getSelectedRow(), 3);
        JD_inserir_impostos jd_impostos = new JD_inserir_impostos(null, true, alq);
        jd_impostos.setVisible(true);
        if (alq.getEmpresa() != null
                && alq.getImposto() != null
    ...
    public boolean contem() {
        ...
        for (int i = 0; i < EMPRESA.getTipoPagamentoList().size(); i++) {
            System.out.println("1 " + EMPRESA.getTipoPagamentoList().get(i).getDescricaoTipoPagamento());
            System.out.println("2 " + jComboBox3.getSelectedItem());
            if (EMPRESA.getTipoPagamentoList().get(i).getDescricaoTipoPagamento().equals(jComboBox3.getSelectedItem().toString())) {
                contem = true;
            }
        }
    ...
    private bd.DAO.Empresa SalvaEmpresa() throws Exception{
        ...
        if(!jTextField9.getText().isEmpty()){
            try {
                EMPRESA.setCodigoMunicipio(new Controller().ControllerFind(bd.DAO.CidadeCodigo.class, jTextField9.getText()));
            } catch (Exception ex) {
            }
        }
